...
typedef struct {				 //Offset
       uint32_t RESERVED0[2];	 //00
  __IO uint32_t ACTLR;			 //08
       uint32_t RESERVED1;		 //0C
  __IO uint32_t STCSR;			 //10
  __IO uint32_t STRVR;			 //14
  __IO uint32_t STCVR;			 //18
  __IO uint32_t STCR;			 //1C
       uint32_t RESERVED2[56];	 //20
  __IO uint32_t ISER;			 //100
       uint32_t RESERVED3[31];	 //104
  __IO uint32_t ICER;			 //180
       uint32_t RESERVED4[31];	 //184
  __IO uint32_t ISPR;			 //200
       uint32_t RESERVED5[31];	 //204
  __IO uint32_t ICPR;			 //280
       uint32_t RESERVED6[95];	 //284
  __IO uint32_t IPR0;			 //400
  __IO uint32_t IPR1;			 //404
  __IO uint32_t IPR2;			 //408
  __IO uint32_t IPR3;			 //40C
  __IO uint32_t IPR4;			 //410
  __IO uint32_t IPR5;			 //414
  __IO uint32_t IPR6;			 //418
  __IO uint32_t IPR7;			 //41C
       uint32_t RESERVED7[568];	 //420
  __IO uint32_t CPUID;			 //D00
  __IO uint32_t ICSR;			 //D04
       uint32_t RESERVED8;		 //D08
  __IO uint32_t AIRCR;			 //D0C
       uint32_t RESERVED9;		 //D10
  __IO uint32_t CCR;			 //D14
       uint32_t RESERVED10;		 //D18
  __IO uint32_t SHPR2;			 //D1C
  __IO uint32_t SHPR3;			 //D20
  __IO uint32_t SHCSR;			 //D24
} SYS_TypeDef;
